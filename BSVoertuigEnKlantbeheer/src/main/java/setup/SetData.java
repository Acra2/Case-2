...
public class SetData implements Serializable {
    ...
    public void setData() {
        ...
        Car a2 = Car.builder().vehicleNumber("JH2HE07C76K308145").licensePlate("KE-90-PA").mileage(4254368).driverEmail("").driverName("").driverPhoneNumber("").customer(c2).build();
        ...
        Maintenance m4 = Maintenance.builder().startDateTime(LocalDateTime.of(2016, 12,  5, 12, 10)).car(a5).mechanic(h3).state(MaintenanceState.PLANNED).type(MaintenanceType.GROOTONDERHOUD).description("Koplampen opnieuw afstellen").build();
